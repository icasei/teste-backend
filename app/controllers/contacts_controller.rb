class ContactsController < ApplicationController
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:cpf_cnpj, :name, :birthday, :email, :mobile, :message, :advertising, :active)
    end
